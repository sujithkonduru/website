    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-2xl max-w-md w-full border-2 border-olive green-400">
        <div className="bg-gradient-to-r from-olive green-400 to-orange-400 p-6 flex items-center justify-between rounded-t-xl">
          <h2 className="text-2xl font-bold text-black">Apply for {internship.title}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-300 mb-2">Department/Branch</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-300 mb-2">Why do you want this internship? *</label>
            <textarea
              required
