 ...
 const benefits = [
  ...
  return (
    <div className="bg-white text-[#1A1A1A] min-h-screen overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 overflow-hidden bg-gradient-to-br from-[#E8F5E9] via-white to-[#E8F5E9]">
        {/* Animated Background */}
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm sm:text-base text-[#1E301E] font-semibold">School Robotics Program</span>
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl md:text-2xl text-[#1A1A1A] max-w-3xl mx-auto leading-relaxed mb-8 px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto mb-8 px-2">
              {stats.map((stat, i) => (
                ...
                >
                  <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#D4AF37] mx-auto mb-1 sm:mb-2" />
            ...
            <motion.button
              ...
              className="px-8 sm:px-10 py-3 sm:py-4 bg-[#1E301E] text-white rounded-full font-semibold text-base sm:text-lg hover:bg-[#2E7D32] transition-all shadow-md hover:shadow-lg inline-flex items-center gap-2 group"
            >
      ...
      <section id="intro" className="scroll-mt-20 py-16 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-base sm:text-lg md:text-xl text-[#1A1A1A] leading-relaxed mb-8">
              We introduce robotics at the school level to help students learn technology in the most enjoyable way possible.
              Our program is specially designed for <span className="text-[#1E301E] font-semibold">Classes 6 to 9</span>, where learning happens naturally through fun, games, and hands-on activities — not pressure or exams.
            </p>

            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              className="inline-block bg-[#E8F5E9] border-2 border-[#D4AF37] rounded-2xl p-6 sm:p-8"
            >
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E301E]">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {whyChoose.map((item, i) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-xl border border-gray-200 hover:border-[#D4AF37] transition-all shadow-sm hover:shadow"
              >
                <item.icon className="w-10 h-10 sm:w-12 sm:h-12 text-[#D4AF37] mb-4" />
                <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] mb-2">{item.title}</h3>
                <p className="text-sm sm:text-base text-[#1A1A1A]">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {benefits.map((benefit, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                whileHover={{ y: -5, scale: 1.02 }}
                className="bg-[#E8F5E9] p-6 rounded-xl border border-gray-200 hover:border-[#D4AF37] transition-all shadow-sm hover:shadow"
              >
                <benefit.icon className="w-10 h-10 sm:w-12 sm:h-12 text-[#D4AF37] mb-4" />
                <h3 className="text-lg sm:text-xl font-bold text-[#1A1A1A] mb-2">{benefit.title}</h3>
                <p className="text-sm sm:text-base text-[#1A1A1A]">{benefit.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              className="lg:w-1/2"
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E301E] mb-4">
                Experience Hands-On Robotics
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-[#1A1A1A] mb-6 leading-relaxed">
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#D4AF37] to-[#D4AF37] rounded-2xl opacity-20 group-hover:opacity-30 blur transition-all" />
                <div className="relative bg-white p-3 sm:p-4 rounded-2xl border border-gray-200 shadow-lg">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-gradient-to-t from-black/80 to-transparent p-3 rounded-lg">
                    <p className="text-[#D4AF37] font-semibold text-sm sm:text-base">Live Robot Demo</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-lg sm:text-xl text-[#1A1A1A] mb-6">This is the moment curiosity takes flight:</p>
              <div className="space-y-3">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.1 }}
                    className="flex items-center gap-3 bg-[#E8F5E9] p-4 rounded-lg hover:bg-[#E8F5E9]/80 transition-all border border-gray-200"
                  >
                    <item.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#D4AF37] flex-shrink-0" />
                    <span className="text-sm sm:text-base text-[#1A1A1A]">{item.text}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200 shadow-sm"
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#1E301E] mb-6">
                Students will:
              </h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-[#E8F5E9] flex items-center justify-center flex-shrink-0 mt-0.5 border border-[#D4AF37]/30">
                      <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 text-[#D4AF37]" />
                    </div>
                    <span className="text-sm sm:text-base text-[#1A1A1A]">{item}</span>
                  </div>
                ))}
              </div>
              <p className="text-base sm:text-lg text-[#1E301E] mt-6 font-semibold">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-[#E8F5E9]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Clock className="w-12 h-12 sm:w-16 sm:h-16 text-[#D4AF37] mx-auto mb-6" />
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-[#1E301E]">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="bg-white p-4 rounded-lg border border-gray-200 hover:border-[#D4AF37] transition-all shadow-sm"
                >
                  <p className="text-sm sm:text-base text-[#1A1A1A]">{item}</p>
                </motion.div>
              ))}
            </div>
            ...
            <motion.div
              ...
              className="inline-block bg-white p-6 rounded-xl border border-[#D4AF37] shadow-sm"
            >
              <p className="text-lg sm:text-xl text-[#1E301E] font-bold">
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                whileHover={{ scale: 1.05 }}
                className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:border-white/40 transition-all text-center"
              >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl font-bold text-center mb-4 text-[#1E301E]"
          >
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {classProgression.map((item, i) => (
              <motion.div
                ...
                className={`bg-white p-6 rounded-2xl border-2 transition-all cursor-pointer shadow-sm hover:shadow ${
                  selectedClass === i
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-[#1E301E]">{item.level}</h3>
                  </div>
                  <ChevronDown className={`w-5 h-5 text-[#D4AF37] transition-transform ${selectedClass === i ? 'rotate-180' : ''}`} />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-[#1A1A1A] mb-2">{item.title}</h4>

                {/* Preview */}
                {selectedClass !== i && (
                  <p className="text-xs sm:text-sm text-[#1A1A1A] italic">
                    {item.benefit}
                  </p>
                )}
                  ...
                  {selectedClass === i && (
                    ...
                    >
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <p className="text-sm text-[#1E301E] font-medium">
                          {item.benefit}
                        </p>
                      </div>
                    </motion.div>
                ...
                {selectedClass !== i && (
                  <p className="text-xs text-[#1A1A1A] mt-2">Click to expand</p>
                )}
              </motion.div>
            ))}
          </div>
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-lg sm:text-xl text-center text-[#1E301E] mt-8 font-bold"
          >
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#D4AF37] transition-all"
              >
                <button
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="w-full p-4 sm:p-5 text-left flex justify-between items-center hover:bg-[#E8F5E9] transition-all gap-3"
                >
                  <h3 className="font-semibold text-[#1A1A1A] text-sm sm:text-base md:text-lg pr-2">{faq.q}</h3>
                  <ChevronDown className={`w-5 h-5 text-[#D4AF37] transition-transform flex-shrink-0 ${openFaq === i ? 'rotate-180' : ''}`} />
                </button>
                  ...
                  {openFaq === i && (
                    ...
                    >
                      <div className="px-4 sm:px-5 pb-4 sm:pb-5 border-t border-gray-200">
                        <p className="text-[#1A1A1A] text-xs sm:text-sm md:text-base pt-2">{faq.a}</p>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
      ...
      {/* Philosophy Banner */}
      <section className="py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-r from-[#1E301E] to-[#2E7D32]">
            ...
            <div className="grid grid-cols-5 gap-2 mb-6">
              {[
                ...
                <motion.div
                  key={i}
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/10 backdrop-blur-sm p-2 rounded-lg hover:bg-white/15 transition-all border border-white/20"
                >
      ...
      {/* Final CTA */}
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-r from-[#D4AF37] to-[#D4AF37]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#1E301E]/80 mb-8 max-w-2xl mx-auto">
