      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
        ...
        >
          ...
          <div className="sticky top-0 bg-gray-800 border-b border-gray-700 p-4 sm:p-6 flex items-center justify-between">
            <h2 className="text-xl sm:text-2xl font-bold text-olive green-400">{title}</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full p-2.5 sm:p-3 rounded-lg bg-gray-700 border border-gray-600 text-white text-sm sm:text-base outline-none focus:border-olive green-400 transition"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="3"
                className="w-full p-2.5 sm:p-3 rounded-lg bg-gray-700 border border-gray-600 text-white text-sm sm:text-base outline-none focus:border-olive green-400 transition resize-none"
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
              ...
              <button
                ...
                className="flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-olive green-400 text-black rounded-lg font-semibold text-sm sm:text-base hover:bg-olive green-300 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
