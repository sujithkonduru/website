    ...
    return (
      <div className="bg-gray-950 text-white min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/R_AND_D" className="text-yellow-400 hover:underline">
    ...
    <div className="bg-gray-950 text-white min-h-screen">
      ...
      <section className="pt-24 pb-12 px-4 sm:px-6 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
        <div className="max-w-6xl mx-auto">
          <Link to="/R_AND_D" className="inline-flex items-center gap-2 text-yellow-400 hover:text-yellow-300 mb-6">
          ...
          >
            <div className="text-yellow-400 text-sm font-semibold mb-3">{project.domain}</div>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">Project Overview</h2>
          ...
          <div className="mt-8 bg-green-900/20 border border-green-500/30 rounded-lg p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-green-400 mb-2">Impact Achieved</h3>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-yellow-400">Research Objectives</h2>
          </div>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-yellow-400">Research Methodology</h2>
          </div>
          <div className="space-y-4">
            {project.methodology.map((step, i) => (
              ...
              >
                <div className="bg-yellow-400 text-black w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">
                  {i + 1}
                </div>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">Technologies & Tools</h2>
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">Expected Outcomes & Deliverables</h2>
          <div className="grid md:grid-cols-2 gap-4">
      ...
      <section className="py-12 px-4 sm:px-6 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">Eligibility Criteria</h2>
      ...
      {/* CTA */}
      <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-yellow-400 to-orange-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="px-8 py-3 bg-black text-yellow-400 rounded-full font-semibold hover:bg-gray-900 transition"
            >
              Apply for This Project
            </button>
            <Link 
              to="/R_AND_D"
              className="px-8 py-3 border-2 border-black text-black rounded-full font-semibold hover:bg-black hover:text-yellow-400 transition inline-block text-center"
            >
              View All Projects
            </Link>
          </div>
